Repository for data analysis of the 11th Measuring Broadband America (MBA) Report

Andreas Freund:
The Internet Real-Time Lab, Columbia University, Department of Computer Science


Overview: 
-The analysis was performed on the MBA's 11th report's validated dataset. 
-The validated dataset from the 11th report contains test results for September-October 2020 
-The analysis leveraged Google's BigQuery for source queries and Jupyter Notebook for further analysis
